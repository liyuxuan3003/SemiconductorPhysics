...
\draw[very thick,gray,dotted] (axis cs:0,8) -- (axis cs:1,8);

\path (axis cs:0.3,11) node[point] {$-$};
\path (axis cs:0.7,11) node[point] {$-$};
\path (axis cs:0.3,5 ) node[point] {$+$};
\path (axis cs:0.7,5 ) node[point] {$+$};

\draw[latex-latex,thin] (axis cs:0.6,10) -- node[pos=0.25,right] {\small $E_\text{g}$} (axis cs:0.6,6);
...
\addplot[domain=0:16,samples=1000,thick,black,line legend] ({1/(exp((x-8)/(0.5))+1)},{x});

\addplot[white] coordinates{(0.5,8)} node[point] {};
\addplot[white] coordinates{(0.017,10)} node[point] {};
\addplot[white] coordinates{(0.983,6)} node[point] {};
...
\addplot [name path=N0,domain=10:16,samples=1000,thick,blue,line legend] ({10*0.4*sqrt(+(x-10))*(1/(exp((x-8)/(1))+1))},{x});

\addplot [name path=P0,domain=0:6,samples=1000,thick,red,line legend] ({10*0.4*sqrt(-(x-6))*(1-1/(exp((x-8)/(1))+1))},{x});
